...
to be configured. For more information about how to configure it, please check [Hetu Statestore](../admin/state-store.html).
...
For more information about how to configure it, please check [Hetu Filesystem](../develop/filesystem.html).
...
See [Adding your own Index Type](./new-index.html).
