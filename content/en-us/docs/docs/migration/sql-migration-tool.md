...
| ADD COMMENTS           | Adding comments to databases or columns is not supported                  | [COMMENT](../sql/comment.html)                       |
...
| SHOW FUNCTIONS         | Only support show all functions or statement with "LIKE".                          | [SHOW FUNCTIONS](../sql/show-functions.html)                       |
