...
有关如何配置它的更多信息， 请参考 [Hetu Metastore](../admin/meta-store.html).
...
更多配置方法请查看[Hetu Statestore](../admin/state-store.html).
...
更多配置方法请查看 [Hetu Filesystem](../develop/filesystem.html).
